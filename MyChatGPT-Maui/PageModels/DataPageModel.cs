...
namespace MyChatGPT_Maui.PageModels
{
	public class DataPageModel : BasePageModel
	{
        ...
        #endregion
        public DataPageModel(IClientInfoServices clientInfoServices) : base(clientInfoServices)
        {
        ...
        private async Task DisplayData()
        {
            try
            {
                ...
                if (ImageCollectionVisible)
                {
                    ...
                    var response = await _clientInfoServices.GetImages(postDataString);
                ...
                else
                {
                    ...
                    var response = await _clientInfoServices.GetText(postDataString);
